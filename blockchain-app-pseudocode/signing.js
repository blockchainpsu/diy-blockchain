...
const sign = (privateKey, message) => {
  ...
  // use secp256k1, sha256, and Buffer to create the signature
  // read into each library's documentation
  // hash the message and combine it with the priv key
  // return the hex representation of the signature
...
const verify = (publicKey, message, signature) => {
  ...
  // ensure the given signature matches what should be the signature with the given pub key and msg
  // use secp256k1, sha256, and Buffer
  // read into each library's documentation
};
